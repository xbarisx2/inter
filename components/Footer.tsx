        ...
        <footer className="bg-brand-blue-950 text-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-brand-blue-100">Hızlı Erişim</h3>
                        <ul className="space-y-2">
                            {NAVIGATION_LINKS.map(link => (
                                <li key={link.name}>
                                    <a href="#" onClick={(e) => { e.preventDefault(); setCurrentPage(link.name); }} className="text-brand-blue-200 hover:text-white transition-colors text-sm">
                                        {link.name}
                                    </a>
                                </li>
                            ))}
                    ...
                    {/* Contact Info */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-brand-blue-100">İletişim</h3>
                        <ul className="space-y-3 text-sm">
                            <li className="flex items-start">
                                <LocationMarkerIcon className="w-5 h-5 mr-3 mt-1 flex-shrink-0 text-brand-blue-300" />
                                <span className="text-brand-blue-200">{COMPANY_INFO.address}</span>
                            </li>
                            <li className="flex items-center">
                                <PhoneIcon className="w-5 h-5 mr-3 flex-shrink-0 text-brand-blue-300" />
                                <a href={`tel:${COMPANY_INFO.phone1}`} className="text-brand-blue-200 hover:text-white">{COMPANY_INFO.phone1}</a>
                            </li>
                            <li className="flex items-center">
                                <MailIcon className="w-5 h-5 mr-3 flex-shrink-0 text-brand-blue-300" />
                     ...
                     {/* Social */}
                     <div>
                        <h3 className="text-lg font-semibold mb-4 text-brand-blue-100">Sosyal Medya</h3>
                ...
                <div className="mt-12 border-t border-brand-blue-800 pt-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
