...
const CompositePage: React.FC = () => {
    ...
    const content = data.COMPOSITE_CONTENT[language === 'tr' ? 'TR' : 'EN'];
            ...
            <div className="bg-brand-blue-900 text-white py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
                        {language === 'tr' ? 'Alüminyum Kompozit Sistemler' : 'Aluminum Composite Systems'}
                    </h1>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-6xl mx-auto mb-20 animate-fade-in-up">
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[400px] md:h-[500px]">
                            <img 
                                src={content.image} 
                                alt={language === 'tr' ? 'Alüminyum Kompozit Sistemleri' : 'Aluminum Composite Systems'} 
                    ...
                    <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
                        <div className="md:col-span-1">
                            <h2 className="text-3xl font-bold text-brand-blue-900">
                                {language === 'tr' ? 'Alüminyum Kompozit Sistemleri' : 'Aluminum Composite Systems'}
                            </h2>
                        </div>
