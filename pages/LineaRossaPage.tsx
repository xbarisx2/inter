        ...
        <>
            <div className="bg-brand-blue-950 text-white py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-4 text-lg text-brand-blue-200 max-w-2xl mx-auto">İtalyan tasarımı ve üstün teknolojinin buluştuğu nokta.</p>
                </div>
            </div>
                        ...
                        {LINEA_ROSSA_PRODUCTS.map((product, index) => (
                            <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col group transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                                ...
                                <div className="p-8 flex-grow flex flex-col">
                                    ...
                                    <button className="mt-6 self-start bg-brand-blue-50 text-brand-blue-700 font-semibold py-2 px-5 rounded-md hover:bg-brand-blue-100 transition-colors">
                                        Teklif Al
                                    </button>
                                </div>
                            </div>
