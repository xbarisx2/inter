...
const LineaRossaPage: React.FC = () => {
    return (
        <>
            {/* Changed background to dark neutral (brand-blue-950) */}
            <div className="bg-brand-blue-950 text-white py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-4 text-lg text-gray-400 max-w-2xl mx-auto font-light">İtalyan tasarımı ve üstün teknolojinin buluştuğu nokta.</p>
                </div>
            </div>
                        ...
                        {LINEA_ROSSA_PRODUCTS.map((product, index) => (
                            <div key={index} className="bg-white rounded-sm shadow-md overflow-hidden flex flex-col group transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-gray-100">
                                ...
                                <div className="p-8 flex-grow flex flex-col">
                                    ...
                                    <button className="mt-8 self-start border-2 border-gray-900 text-gray-900 font-bold py-3 px-8 hover:bg-gray-900 hover:text-white transition-all duration-300 uppercase text-sm tracking-wide">
                                        Teklif Al
                                    </button>
                                </div>
                            </div>
